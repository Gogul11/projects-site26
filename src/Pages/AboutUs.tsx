    ...
    return (
        <div className='w-full h-screen flex flex-col justify-center items-center gap-4 md:flex-row
            ...
            <div className='h-[50%] w-full md:h-full md:w-[50%] flex flex-col gap-5 justify-center items-center'> 
                <p
                    className='source_code_pro text-3xl max-[420px]:text-2xl max-xs text-[#28282b] font-semibold'
                >Meet our purpose</p>
                {cards.map((card, idx) => (
                    <div
                        key={idx}
                        className="px-6 py-3 bg-white/10 rounded-lg border border-[#28282b]/10
            ...
            <div className='h-[50%] w-full flex flex-col justify-center items-center gap-4 md:h-full md:w-[50%] mb-4'> 
                <a 
                    className='flex justify-center items-center w-fit gap-1 bg-black/10 border border-[#28282b]/10 rounded-lg px-2 py-1' 
