...
const AchievementDetailCard : React.FC<props> = (props) => {
    return (    
        <div className='fixed z-50 inset-0 bg-black/10 backdrop-blur-2xl p-10 overflow-y-auto'>
            <button className="absolute top-8 right-8 text-white hover:text-[#28282b]/50 z-10 cursor-pointer" onClick={props.onClose}>
                    <FaGear size={24} />
            </button>
            ...
            <div className='mt-6'>
                <div className='flex flex-col w-full justify-center items-center gap-10 p-1
                    ...
                    <img 
                        ...
                        alt="" />
                    <p className='text-2xl md:text-3xl font-bold underline text-[#28282b]'>
                            {props.name}
                    </p>
                </div>
                <div 
