...
const GlassCard: React.FC<CardProps> = ({ title, content, image, onClose }) => {
  ...
  return (
    <div 
		className="bg-black/5 fixed inset-0 z-50 p-4 overflow-y-auto backdrop-blur-md flex sm:justify-center ani"
		onClick={onClose}
	>
		...
		>
	    	<img src={image} alt={title} className="w-full h-fit object-cover rounded-t-3xl" />
